...
//                        if (JpaReflectionHelper.getInstance().isIntField(clazz, fieldName)) {
//                            query.setParameter(entry.getKey(), Integer.parseInt(entry.getValue()));
//                        } else if (JpaReflectionHelper.getInstance().isEntity(clazz, fieldName)) {
//                            query.setParameter(entry.getKey(), Integer.parseInt(entry.getValue()));  
//                        } else if(JpaReflectionHelper.getInstance().isBigDecimal(clazz, fieldName)) {
//                            String value = entry.getValue(); 
//                            if(value.toLowerCase().startsWith(BETWEEN)) { 
...
//                            }  
//                        } else if(JpaReflectionHelper.getInstance().isDate(clazz, fieldName)) {
//                            String value = entry.getValue();
//                            if(value.toLowerCase().startsWith(BETWEEN)) { 
